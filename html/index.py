...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function send_tx(){
                ...
                else if(!((address.substr(0, 4) == "dERo" && address.length == 98) || (address.substr(0, 4) == "dERi"  && address.length == 109))){
    ...
    <body>
		<div style="background-image:url(./images/dero_header.png); height: 50px; background-repeat: norepeat;">
		</div>
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="col-xs-6" style="text-align:right">
                                <h5><span id="balance">0.000000000000</span> <small>DERO</small> <span class="syncing"> (syncing)</span></h5>
                                <h5><span id="unlocked_balance">0.000000000000</span> <small>DERO</small> <span class="syncing"> (syncing)</span></h5>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-xs-8">
                                        <select id="send_mixins" class="form-control">
                                          <option value="11" selected>11 mixins (default)</option>
        ...
        <script id="recent_tx_row_templ" type="x-tmpl-mustache">
            <div class="col-sm-12">
                <div class="col-xs-10" style="padding-right:0">
                    <p class="tx-list tx-{{cls_in_out}}"><i class="fa fa-{{ tx_fa_icon }}"></i> ({{tx_direction}}) <span class="tx-list txid"><a href="javascript:open_link('https://explorer.dero.io/tx/{{ tx_id }}')" title="View on blockchain explorer">{{ tx_id }}</a></span></p>
        ...
        <script id="tx_detail_templ" type="x-tmpl-mustache">
            <p class="tx-list tx-{{cls_in_out}}" style="font-size: 90%"><i class="fa fa-{{ tx_fa_icon }}"></i> {{tx_direction}}<br>
                <span class="tx-list txid"><a href="javascript:open_link('https://explorer.dero.io/tx/{{ tx_id }}')" title="View on blockchain explorer">{{ tx_id }}</a></span>
            </p>
